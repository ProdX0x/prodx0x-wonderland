...
export const apps = [
  { id:'iris', name:'Iris', device:'iphone', status:'development', tagline:'Un jeu contrôlé par le regard.', subtitle:'Une nouvelle façon de jouer', description:'Et si un simple regard ouvrait un nouveau monde ? Iris imagine une expérience de jeu sensible et accessible, dans laquelle vos yeux dessinent le chemin. Un concept d’application pour explorer une interaction plus naturelle.', technologies:['SwiftUI','ARKit','Eye tracking'], color:'#d1dbaa', symbol:'◉', chapter:'Le jardin des possibles', image:null, video:null, link:null },
